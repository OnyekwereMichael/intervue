        ...
        <div>
           ...
           <div className='flex flex-row gap-5 mt-3'>
             <div className='flex flex-row gap-2'>
              <Image src={Calander} alt='Calander ' width={22} height={22}/>
              <p>{formattedDate}</p>
            </div>

            <div className='flex flex-row gap-2 items-center'>
              <Image src='/star.svg' alt='Interview' width={22} height={22}/>
           ...
           <div className='flex flex-row  justify-between items-center mt-4'>
            ...
            <Button  className='btn-primary'>
              <Link href={feedback ? `/interview/${interviewId}/feedback` : `interview/${interviewId}`} className='w-full'>{feedback ? 'Check Feedback' : 'View Interview'}</Link>
            </Button>  
           </div>
        </div>
      </div>
